...
function Pomodoro() {
  ...
  function handleIncreaseFocus() {
    ...
    setFocusDuration((focusState) => focusState + 5);
  }
  ...
  function handleIncreaseBreak() {
    ...
    setBreakDuration((breakState) => breakState + 1);
  }
  ...
  return (
    <div className="pomodoro">
      <div className="row">
        <div className="col">
          <Duration session={session} duration={focusDuration} focusOrBreak={onFocus} increase={handleIncreaseFocus} decrease={handleDecreaseFocus}/>
        </div>
        <div className="col">
          <div className="float-right">
            <Duration session={session} duration={breakDuration} focusOrBreak={onBreak} increase={handleIncreaseBreak} decrease={handleDecreaseBreak} />
          </div>
        </div>
      </div>
      <div className="row">
